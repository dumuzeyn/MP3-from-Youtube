...
5. Если YouTube просит подтвердить, что вы не бот, выберите в поле `Cookies браузера` браузер, где вы уже вошли в YouTube.
6. Нажмите `Скачать MP3`.

Если появляется ошибка `Sign in to confirm you’re not a bot`, откройте YouTube в Chrome, Edge, Firefox, Brave, Opera или Vivaldi, войдите в аккаунт, затем выберите этот браузер в приложении и повторите скачивание.
...
5. If YouTube asks to confirm you are not a bot, choose the browser where YouTube is already signed in in `Browser cookies`.
6. Press `Download MP3`.

If you see `Sign in to confirm you’re not a bot`, open YouTube in Chrome, Edge, Firefox, Brave, Opera, or Vivaldi, sign in, choose that browser in the app, and try again.
